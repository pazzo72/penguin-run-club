...
interface Props { onHalfway?: () => void; }
...
export default function PenguinCanvas1({ onHalfway }: Props) {
  ...
  useMotionValueEvent(smoothProgress, 'change', (val) => {
    ...
    if (val >= 0.5 && !halfwayTriggeredRef.current) { halfwayTriggeredRef.current=true; onHalfway?.(); }
  ...
  // Beat A (0) = gold, B (1) = navy, C (2) = gold, D (3) = navy
      ...
      <div className="sticky top-0 overflow-hidden" style={{ height: '100vh' }}>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div className="absolute inset-0 flex flex-col justify-center"
            ...
            <h2 style={{ ...navyBeatStyle, textAlign: 'left' }}>Il tuo ritmo.</h2>
          </motion.div>
          ...
          <motion.div className="absolute inset-0 flex flex-col items-end justify-center"
            ...
            <h2 style={{ ...goldBeatStyle, textAlign: 'right' }}>La tua montagna.</h2>
          </motion.div>

          {/* Beat D — navy — centrato */}
          <motion.div className="absolute inset-0 flex flex-col items-center justify-center px-8"
            style={{ opacity: beatDOpacity, y: beatDY }}>
            <h2 style={{ ...navyBeatStyle, textAlign: 'center' }}>Cammina da solo.</h2>
          </motion.div>

          {/* Final: BE THE PENGUIN — gold gradient */}
          {finalPhase > 0 && (
            <div className="absolute inset-0 flex flex-col items-center justify-center px-6">
              <h1
                style={{
                  ...
                  ...GOLD_TEXT, paddingBottom: '0.15em',
                }}
              ...
              {/* CTA — navy bg + gold gradient text */}
              <motion.div className="mt-8 pointer-events-auto"
                ...
                <motion.a
                  ...
                  style={{
                    ...
                    borderRadius: '0.2rem', background: '#0C1A2E',
                ...
                >
                  <span style={{ ...GOLD_TEXT, display: 'inline-block' }}>Scopri il club →</span>
                </motion.a>
              </motion.div>
            </div>
          )}
